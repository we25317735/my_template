...
router.post('/', async function (req, res, next) {
  ...
  const twitter_uid = uid

  console.log('後端捕獲: ', displayName, email, uid, photoURL)

  // 以下流程:
  // 1. 先查詢資料庫是否有同twitter_uid的資料
  // 2-1. 有存在 -> 執行登入工作
  ...
  if (total) {
    ...
    returnUser = {
      ...
      twitter_uid: dbUser.twitter_uid,
    ...
    returnUser = {
      id: newUser.id,
      username: '',
      twitter_uid: newUser.twitter_uid,
